...
#define VERTEX_BUFFER_BIND_POINT 0
namespace Vulkan
{
	...
	struct VkVertex
	{
		...
		static VkVertexInputBindingDescription getBindingDescription() {
			...
			bindingDescription.binding = VERTEX_BUFFER_BIND_POINT;
		...
		static std::vector<VkVertexInputAttributeDescription> getAttributeDescriptions() {
			...
			attributeDescriptions[0].binding = VERTEX_BUFFER_BIND_POINT;
			attributeDescriptions[0].location = 0;
			attributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;
			attributeDescriptions[0].offset = offsetof(VkVertex, pos);

			attributeDescriptions[1].binding = VERTEX_BUFFER_BIND_POINT;
			attributeDescriptions[1].location = 1;
			attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
			attributeDescriptions[1].offset = offsetof(VkVertex, normal);

			attributeDescriptions[2].binding = VERTEX_BUFFER_BIND_POINT;
			attributeDescriptions[2].location = 2;
			attributeDescriptions[2].format = VK_FORMAT_R32G32B32_SFLOAT;
			attributeDescriptions[2].offset = offsetof(VkVertex, color);

			attributeDescriptions[3].binding = VERTEX_BUFFER_BIND_POINT;
			attributeDescriptions[3].location = 3;
			attributeDescriptions[3].format = VK_FORMAT_R32G32_SFLOAT;
			attributeDescriptions[3].offset = offsetof(VkVertex, texCoord);

			attributeDescriptions[4].binding = VERTEX_BUFFER_BIND_POINT;
			attributeDescriptions[4].location = 4;
			attributeDescriptions[4].format = VK_FORMAT_R32G32B32_SFLOAT;
			attributeDescriptions[4].offset = offsetof(VkVertex, tanget);
