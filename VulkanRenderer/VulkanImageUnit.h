...
namespace Vulkan
{
	...
	public:
		...
		void CopyImage(VkManagedImage& source, VkManagedImage& dest, uint32_t sourceWidth, uint32_t sourceHeight, uint32_t sourceDepth, VkOffset3D sourceOffset, VkOffset3D destOffset, VkImageSubresourceLayers sourceLayers, VkImageSubresourceLayers destLayers);
	...
	private:
		...
		void BlitImage(VkImage source, VkImage destination, VkImageCopy copyData);
	private:
